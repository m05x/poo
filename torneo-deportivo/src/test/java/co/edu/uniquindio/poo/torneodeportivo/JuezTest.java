...
public class JuezTest {
    ...
    @Test
    public void testLicenciaRepetida() {
    ...
    @Test
    public void registrarJuezEnTorneo(){
        LOG.info("Inicio de prueba registrarJugadorEquipo...");
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.of(2023, 10, 1), LocalDate.of(2023, 8, 1), LocalDate.of(2023, 9, 15), (byte)24, (byte)0, 0,TipoTorneo.LOCAL,Genero.MIXTO);

        Juez juez = new Juez("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300",Genero.MASCULINO,"2345687");
