...
public class JugadorTest {
    ...
    public void registrarJugadorEquipo() {
        ...
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",Genero.MASCULINO ,LocalDate.now().minusYears(15) );
    ...
    public void registrarJugadorTorneo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,Genero.MIXTO);
    ...
    public void registrarJugadorTorneoSinLimiteEdad() {
        ...
        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300",Genero.MASCULINO);
        var equipo = new Equipo("Uniquindio", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",Genero.MASCULINO,LocalDate.now().minusYears(21));
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(1), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,Genero.MIXTO);
    ...
    public void registrarJugadoresRepetidosEquipo() {
        ...
        var equipo = new Equipo("Uniquindio", representante);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",Genero.MASCULINO,LocalDate.now().minusYears(15));
        var jugador2 = new Jugador("Christian", "Candela", "ccandela@email.com", "6067431235",Genero.MASCULINO,LocalDate.now().minusYears(15));
        equipo.registrarJugador(jugador);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15), LocalDate.now().plusDays(15), (byte)24, (byte)18, 0,TipoTorneo.LOCAL,Genero.MIXTO);
